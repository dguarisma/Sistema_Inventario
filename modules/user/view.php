  ...
  <div class="row">
    ...
    elseif ($_GET['alert'] == 1) {
      echo "<div class='alert alert-success alert-dismissable'>
              ...
              Los nuevos datos de usuario se han registrado correcamente.
            </div>";
    }
              ...
              echo "  <td>$data[username]</td>
                      ...
                      <td class='center' width='100'>
                          ...
                          if ($data['status']=='activo') { ?>
                            <a data-toggle="tooltip" data-placement="top" title="Bloqueado" style="margin-right:5px" class="btn btn-danger btn-sm" href="modules/user/proses.php?act=off&id=<?php echo $data['id_user'];?>">
