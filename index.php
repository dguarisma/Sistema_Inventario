...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Login | Sweet Donuts</title>
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#brbrbr" class="login-logo">
        <img style="margin-top:-12px" src="./assets/img/apple-icon-144x144.png" alt="Logo" height="50"> <b>Sweet Donuts</b>
      </div><!-- /.login-logo -->
      <?php  
