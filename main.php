...
<head>
  <meta charset="UTF-8">
  <title>Sweet Donuts</title>
  <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  <meta name="description" content="Servio de pedidos">
  <meta name="author" content="Servicio de pedidos de donas - Sweet Donuts" />
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="?module=beranda" class="logo">
        <img style="margin-top:-5px" src="./assets/img/android-icon-36x36.png" alt="Logo">
        <span style="font-size:20px">Sweet Donuts</span>
      </a>
